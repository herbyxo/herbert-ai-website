...
const projects = [
  {
    ...
    cover: '/portfolio/home_-_spark.png',
    screenshots: [
  ...
  },
  {
    ...
    cover: '/portfolio/home_-_haircut.png',
    screenshots: [
  ...
  },
  {
    ...
    cover: '/portfolio/home_-_cafe.png',
    screenshots: [
    ...
    <>
      ...
      <section className="bg-white py-20 border-b border-gray-100">
        <div className="container mx-auto px-4 max-w-5xl">
          <p className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-4">Our Work</p>
