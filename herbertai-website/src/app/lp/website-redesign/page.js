...
export default function Page() {
  return (
    <LandingPage
      ...
      h1="Rebuild your website without losing your Google ranking."
      ...
      checks={['New homepage mockup in 48 hours', 'Redirects handled, rankings kept', 'The old site stays up until the new one is live']}
      steps={[
        ...
        { title: 'Like it? Fixed quote, and the move is handled', body: 'Every old address redirects to its new page. Content moved. Rankings kept.' },
      ]}
      faqs={[
